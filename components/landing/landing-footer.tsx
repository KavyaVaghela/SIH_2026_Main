      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Link href="/" className="flex items-center space-x-3 group" id="footer-logo">
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#135e38] text-white border border-[#8ed5a5] shadow-sm transition-transform group-hover:scale-105">
                <Building2 className="h-6 w-6 text-[#8ed5a5]" />
              </div>
              <div className="flex flex-col">
                <span className="font-bold text-xl tracking-tight text-white">KaushalyaSetu</span>
                <span className="text-xs font-medium text-[#8ed5a5]">
          ...
          <div>
            <h4 className="text-sm font-bold text-white uppercase tracking-wider mb-4 border-b border-[#135e38] pb-2">
              Navigation
            </h4>
            <ul className="space-y-2.5 text-xs text-[#eaf5ee]/90">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-[#eaf5ee]/90">
        ...
        <div className="mt-12 pt-8 border-t border-[#135e38] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#8ed5a5]">
