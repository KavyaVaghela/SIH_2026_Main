...
export function LandingHowItWorks() {
  ...
  const steps = [
    {
      number: "01",
      title: t("landing.howItWorks.step1Title", "Request"),
      description: t("landing.howItWorks.step1Desc", "Customer chooses a service and submits the job details."),
    },
    {
      number: "02",
      title: t("landing.howItWorks.step2Title", "Compare"),
      description: t("landing.howItWorks.step2Desc", "Nearby eligible workers receive the request and can submit itemized estimates."),
    },
    {
      number: "03",
      title: t("landing.howItWorks.step3Title", "Confirm"),
      description: t("landing.howItWorks.step3Desc", "Customer compares worker information and estimates and selects a worker."),
    },
    {
      number: "04",
      title: t("landing.howItWorks.step4Title", "Verify"),
      description: t("landing.howItWorks.step4Desc", "Worker arrives and uses the customer's 4-digit OTP before the service starts."),
    },
    {
      number: "05",
      title: t("landing.howItWorks.step5Title", "Complete"),
      description: t("landing.howItWorks.step5Desc", "Worker completes the service, generates an itemized bill, and the customer reviews and pays."),
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-6 sm:mb-8">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#eaf5ee] text-[#004525] text-xs font-bold border border-[#8ed5a5] mb-2">
            <span>{t("landing.howItWorks.eyebrow", "5-Step Workflow")}</span>
          </div>
          <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#111827]">
            {t("landing.howItWorks.title", "How KaushalyaSetu Works")}
          </h2>
          <p className="mt-1.5 text-xs sm:text-sm text-[#374151]">
            {t("landing.howItWorks.subtitle", "A clear and transparent service journey connecting households and cooperative workers.")}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-6 space-y-2">
            ...
            <div className="pt-4 pl-5 md:pl-6 ml-4">
              ...
              >
                <span>{t("landing.howItWorks.findServiceCta", "Find a Service")}</span>
              ...
              <div className="rounded-2xl sm:rounded-3xl bg-white border border-[#e6f0ea] shadow-lg p-4 sm:p-5 relative overflow-hidden">
                ...
                <div className="rounded-xl sm:rounded-2xl bg-[#f4fbf6] border border-[#8ed5a5]/60 p-3 sm:p-4">
                  <div className="flex items-center justify-between gap-2 text-[10px] sm:text-[11px] font-bold text-[#004525] uppercase tracking-wider">
                    ...
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-white text-[#135e38] border border-[#8ed5a5] text-[10px] font-semibold">
                      <Clock className="w-3 h-3 text-[#135e38]" /> {t("landing.howItWorks.previewEstimatesReceived", "2 Estimates Received")}
                    </span>
                  </div>
                  ...
                  <div className="mt-2 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1.5">
                    <div>
                      <h4 className="text-sm sm:text-base font-extrabold text-[#111827]">
                        {t("landing.howItWorks.previewJobTitle", "Electrical Diagnostics & MCB Repair")}
                      </h4>
                      <p className="text-xs text-[#6b7280] flex items-center gap-1.5 mt-0.5">
                        <Calendar className="w-3 h-3 text-[#135e38]" /> {t("common.today", "Today")} • 4:00 PM
                      </p>
                    </div>
                    <div className="sm:text-right">
                      <span className="inline-block text-[11px] font-semibold px-2 py-0.5 rounded-md bg-[#eaf5ee] text-[#135e38] border border-[#8ed5a5]/40">
                        {t("landing.howItWorks.previewReadyToCompare", "Ready to Compare")}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-3.5 mb-2.5 flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                  <div className="flex items-center gap-2">
                    <span className="text-[11px] font-extrabold uppercase tracking-wider text-[#111827]">
                      {t("landing.howItWorks.previewAvailableWorkers", "AVAILABLE WORKERS")}
                    </span>
                    <span className="text-[10px] font-bold px-1.5 py-0.5 rounded-full bg-[#eaf5ee] text-[#135e38]">
                      {t("landing.howItWorks.previewEligible", "2 eligible")}
                    </span>
                  </div>
                  <span className="text-[10px] sm:text-[11px] text-[#135e38] font-semibold flex items-center gap-1">
                    <Sparkles className="w-3 h-3" /> {t("landing.howItWorks.previewCompareAdvice", "Compare workers before you confirm")}
                  </span>
                </div>
                  ...
                  <div className="rounded-xl border-2 border-[#135e38] bg-[#f4fbf6] p-3 sm:p-3.5 relative shadow-sm transition-all">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
                        ...
                        <div>
                          <div className="flex items-center gap-1.5 flex-wrap">
                            ...
                            <span className="inline-flex items-center gap-0.5 text-[9px] font-semibold text-[#135e38] bg-white px-1.5 py-0.5 rounded-full border border-[#8ed5a5]">
                              <Check className="w-2.5 h-2.5 text-[#135e38]" /> {t("landing.howItWorks.previewVerified", "Verified")}
                            </span>
                          </div>
                          <p className="text-[11px] text-[#374151] mt-0.5 font-medium">
                            {t("landing.howItWorks.previewWorker1Title", "Certified Electrician • 6 yrs exp")}
                          </p>
                          <div className="flex items-center gap-2 mt-0.5 text-[10px] text-[#6b7280]">
                            ...
                            <span className="flex items-center gap-0.5">
                              <MapPin className="w-2.5 h-2.5 text-[#135e38]" /> {t("landing.howItWorks.previewDistance", { dist: "2.4" }, "2.4 km away")}
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="sm:text-right pt-1.5 sm:pt-0 border-t sm:border-t-0 border-[#e6f0ea] flex sm:flex-col items-baseline sm:items-end justify-between sm:justify-center">
                        <span className="text-[10px] text-[#6b7280] font-medium sm:block">{t("landing.howItWorks.previewEstimateLabel", "Estimate")}</span>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
                      ...
                      <div className="flex items-start gap-2.5">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-[#374151] mt-0.5 font-medium">
                            {t("landing.howItWorks.previewWorker2Title", "Certified Electrician • 4 yrs exp")}
                          </p>
                          <div className="flex items-center gap-2 mt-0.5 text-[10px] text-[#6b7280]">
                            <span className="flex items-center gap-0.5 font-bold text-[#111827]">
                              <Star className="w-3 h-3 fill-[#135e38] text-[#135e38]" />
                            ...
                            <span>•</span>
                            <span className="flex items-center gap-0.5">
                              <MapPin className="w-2.5 h-2.5 text-[#135e38]" /> {t("landing.howItWorks.previewDistance", { dist: "3.1" }, "3.1 km away")}
                            </span>
                          </div>
                        </div>
                      </div>
                ...
                <div className="mt-3.5">
                  ...
                  >
                    ...
                    <span>{t("landing.howItWorks.previewCompareCta", "Compare Estimates & Select Worker")}</span>
                ...
                <div className="mt-2.5 flex items-center justify-center gap-1.5 text-[10px] sm:text-[11px] text-[#374151] font-medium text-center">
                  ...
                  <span>{t("landing.howItWorks.previewFooterNote", "Compare workers before you confirm • OTP job verification")}</span>
                </div>
              </div>
            </div>
          </div>
