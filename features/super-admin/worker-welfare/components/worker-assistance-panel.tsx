...
import { LifeBuoy, Clock, CheckCircle2, AlertCircle, Eye } from "lucide-react";
    ...
    <Card className="border border-border/80 shadow-sm flex flex-col justify-between h-full">
      ...
      <CardContent className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
          <div className="p-2 rounded-lg bg-amber-50/60 dark:bg-amber-950/40 border border-amber-200/50 dark:border-amber-900/40 text-center">
            <div className="text-base font-bold text-amber-700 dark:text-amber-400">{stats.pending}</div>
            <div className="text-[10px] font-semibold text-muted-foreground">Pending Requests</div>
          </div>

          <div className="p-2 rounded-lg bg-blue-50/60 dark:bg-blue-950/40 border border-blue-200/50 dark:border-blue-900/40 text-center">
            <div className="text-base font-bold text-blue-700 dark:text-blue-400">{stats.underReview}</div>
            <div className="text-[10px] font-semibold text-muted-foreground">Under Review</div>
          </div>

          <div className="p-2 rounded-lg bg-emerald-50/60 dark:bg-emerald-950/40 border border-emerald-200/50 dark:border-emerald-900/40 text-center">
            <div className="text-base font-bold text-emerald-700 dark:text-emerald-400">{stats.approved}</div>
            <div className="text-[10px] font-semibold text-muted-foreground">Approved</div>
          </div>

          <div className="p-2 rounded-lg bg-purple-50/60 dark:bg-purple-950/40 border border-purple-200/50 dark:border-purple-900/40 text-center">
            <div className="text-base font-bold text-purple-700 dark:text-purple-400">{stats.resolved}</div>
            <div className="text-[10px] font-semibold text-muted-foreground">Resolved</div>
          </div>
        </div>
