...
export const ROLE_NAVIGATION_CONFIGS: Record<PlatformRole, RoleNavigationConfig> = {
  SUPER_ADMIN: {
    ...
    navItems: [
      ...
      { title: "Demand & Analytics", href: "/super-admin/analytics", icon: React.createElement(BarChart3) },
  ...
  FEDERATION_ADMIN: {
    ...
    navItems: [
      ...
      { title: "AI Intelligence", href: "/federation-admin/ai-intelligence", icon: React.createElement(BrainCircuit) },
      { title: "Large Projects", href: "/federation-admin/projects", icon: React.createElement(Building2) },
  ...
  WORKER: {
    ...
    navItems: [
      ...
      { title: "Kaushal Bandhu", href: "/worker/kaushal-bandhu", icon: React.createElement(Sparkles) },
